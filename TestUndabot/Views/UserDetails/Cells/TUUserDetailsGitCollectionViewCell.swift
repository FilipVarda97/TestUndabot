//
//  TUUserDetailsGitCollectionViewCell.swift
//  TestUndabot
//
...
final class TUUserDetailsGitCollectionViewCell: UICollectionViewCell {
    static let identifier = "TUUserDetailsGitCollectionViewCell"
