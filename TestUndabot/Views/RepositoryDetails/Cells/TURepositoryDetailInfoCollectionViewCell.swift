//
//  TURepositoryDetailInfoCollectionViewCell.swift
//  TestUndabot
//
...
final class TURepositoryDetailInfoCollectionViewCell: UICollectionViewCell {
    static let identifier = "TURepositoryDetailInfoCollectionViewCell"
    ...
    public func configure(with viewModel: TURepositoryDetailInfoCollectionViewCellViewModel) {
