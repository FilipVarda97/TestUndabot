//
//  TURepositoryDetailUrlsCollectionViewCell.swift
//  TestUndabot
//
...
final class TURepositoryDetailUrlsCollectionViewCell: UICollectionViewCell {
    static let identifier = "TURepositoryDetailUrlsCollectionViewCell"
    ...
    public func configure(with viewModel: TURepositoryDetailUrlsCollectionViewCellViewModel) {
